<%-- 
    Document   : employer-packages
    Created on : Sep 23, 2020, 10:13:22 AM
    Author     : HP
--%>
...
<!-- Mirrored from grandetest.com/theme/careerup-html/page-employer-packages.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2019 19:10:20 GMT -->
<head>
<meta charset="utf-8">
					...
					<div class="dropdown">
					    ...
					    <div class="dropdown-menu">
					    	...
					    	<div class="user_setting_content">
								...
								<a class="dropdown-item" href="page-employer-manage-job.html"><span class="flaticon-paper-plane"></span> Manage Jobs</a>
								<a class="dropdown-item" href="page-employer-resume.html"><span class="flaticon-analysis"></span> Shortlisted Resumes</a>
								<a class="dropdown-item active" href="page-employer-packages.html"><span class="flaticon-favorites"></span> Packages</a>
								<a class="dropdown-item" href="page-employer-transactions.html"><span class="flaticon-chat"></span> Transactions</a>
								<a class="dropdown-item" href="page-candidates-change-password.html"><span class="flaticon-locked"></span> Change Password</a>
								<a class="dropdown-item" href="page-log-reg.html"><span class="flaticon-logout"></span> Logout</a>
								<a class="dropdown-item" href="#"><span class="flaticon-rubbish-bin"></span> Delete Profile</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-lg-4 col-xl-3 dn-smd">
					...
					<div class="dashbord_nav_list">
						<ul>
							...
							<li class="active"><a href="page-employer-packages.html"><span class="flaticon-favorites"></span> Packages</a></li>
				...
				<div class="col-sm-12 col-lg-8 col-xl-9">
					<div class="row">
						<div class="col-lg-12">
							<h4 class="fz20 mb30">Packages</h4>
						</div>
						<div class="col-lg-12">
									...
									<table class="table">
										<thead class="thead-light">
									    	<tr>
									    		...
									    		<th scope="col">Total Jobs/CVs</th>
