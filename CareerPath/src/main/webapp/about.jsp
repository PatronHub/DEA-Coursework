<%-- 
    Document   : about
    Created on : Sep 23, 2020, 2:01:45 AM
    Author     : HP
--%>
...
<!-- Mirrored from grandetest.com/theme/careerup-html/page-about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2019 19:10:29 GMT -->
...
<head>
	...
	<!-- Title -->
	<title>CareerPath - The Most Popular Job Board</title>
	<!-- Favicon -->
			...
			<div class="container">
				...
				<nav>
					...
					<div class="menu-toggle">
						<img class="nav_logo_img img-fluid" src="images/header-preview.png" alt="header-preview.png">
					...
					<a href="index.html" class="navbar_brand float-left dn-smd">
						<img class="img-fluid mt10" src="images/header-preview.png" alt="header-preview.png">
					</a>
					...
					<ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
						...
						<li>
							...
							<ul>
								...
								<li>
									<a href="#">Job Single</a>
									<ul>
										<li><a href="job-single-view.jsp">Single view</a></li>
									</ul>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul>
								<li>
									...
									<!-- Level Three-->
									<ul>
										<li><a href="employer-list-view,jsp">List view</a></li>
									</ul>
								</li>
								<li>
									...
									<!-- Level Three-->
									<ul>
										<li><a href="employer-single-viewjsp">Single view</a></li>
									</ul>
								</li>
								<li>
									...
									<!-- Level Three-->
									<ul>
										<li><a href="employer-dashboard.jsp">Dashboard</a></li>
										<li><a href="employer-profile.jsp">Profile</a></li>
										<li><a href="employer-post-job.jsp">Post Job</a></li>
										<li><a href="employer-manage-jobjsp">Manage Job</a></li>
										<li><a href="employer-resume.jsp">Resume</a></li>
										<li><a href="employer-change-password.jsp">Change Password</a></li>
									</ul>
								</li>
							</ul>
						</li>
						...
						<li>
							...
							<ul>
								...
								<li><a href="log-reg.jsp">Login/Register</a></li>
								<li><a href="terms-and-policies.jsp">Terms And Policies</a></li>
								
							</ul>
						</li>
						<li class="last">
							<a href="employer-post-job.jsp"><span class="title">Post a Job</span></a>
						</li>
					</ul>
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="about_content">
							<h3>About Career Path</h3>
							<p class="color-black22 mt30"> Career Path is the Sri Lanka’s leading destination to find the
								top jobs and new job vacancies from the leading companies in Sri Lanka. We have
								partnered with many companies and their HR divisions to provide the best talent to the
								right role.</p>
                                                        
							<p class="color-black22 mt30"> Finding your Dream Job is a two-way process. As much as a company would like to hire a
								candidate, the top job seekers always evaluate the company to ensure that it’s the best
								match for their talents. Therefore we attempt to match the candidates based on many
								metrics other than just qualifications.Other than full-time and part-time positions, Sri
								Lankan employers are looking for candidates for express jobs or temp jobs as well. Get
								on the express lane in your career success by applying for the right job, that sets you
								apart. The vacancies for express jobs or temporary positions fill up quickly, so you need
								to act quick when you see the right position to apply.</p>
                                                        
							<p class="color-black22 mt30">We categorize the job vacancies in Sri Lanka in to many categories,
								including Government, private, Sri Lanka Jobs, Overseas Jobs, top jobs and entry-level
								jobs for school leavers. Search and apply now for your Dream Job, or sign-in and create
								a job alert, so that you can apply as soon as new jobs are published. We guide you for
								the best career opportunities offered by many highly reputed companies in Sri Lanka and
								some other countries..</p>
                                                        
							<a class="btn btn-thm mt15" href="#">Search Jobs <span
									class="fa fa-long-arrow-right pl10"></span></a>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="about_thumb mt50">
							<img class="img-fluid" src="images/about/1.jpg" alt="1.jpg">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-sm-6 col-lg-4 prpl5 mt20-xxsd">
						<div class="icon_box_hiw">
							...
							<div class="details">
								<h4>Save & Apply</h4>
								<p>Use the Up work platform to chat, share files, and collaborate from your desktop or on
									the go.</p>
							</div>
						</div>
					</div>
						...
						<div class="testimonial_slider">
							<div class="item">
								...
								<div class="testimonial_post text-center">
									...
									<div class="details">
										<p>“I'm wondering why I never contacted these guys sooner! Seriously, they all
											have commendable talent in their respective fields and knocked my concept
											out of the ballpark. Thanks for an amazing experience!” </p>
									</div>
								</div>
							</div>
							<div class="item">
						...
						<div class="team_slider">
							<div class="item">
								<div class="team_member">
									<div class="tm_thumb">
										<img class="img-fluid" src="images/team/10.jpg" alt="10.jpg">
									</div>
									<div class="overlay">
							...
							<div class="item">
								<div class="team_member">
									<div class="tm_thumb">
										<img class="img-fluid" src="images/team/11.jpg" alt="11.jpg">
									</div>
									<div class="overlay">
										<div class="tm_social_icon">
											<ul>
							...
							<div class="item">
								<div class="team_member">
									<div class="tm_thumb">
										<img class="img-fluid" src="images/team/12.jpg" alt="12.jpg">
									</div>
									<div class="overlay">
										<div class="tm_social_icon">
											<ul>
							...
							<div class="item">
								<div class="team_member">
									<div class="tm_thumb">
										<img class="img-fluid" src="images/team/13.jpg" alt="13.jpg">
									</div>
									<div class="overlay">
										<div class="tm_social_icon">
											<ul>
				...
				<div class="row">
					<div class="col-sm-12 col-lg-2 pb25 pt25">
						<div class="logo-widget">
							<img class="img-fluid" src="images/footer-preview.png" alt="footer-preview.png">
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-sm-8 col-md-6 col-md-3 col-lg-6">
						<div class="newsletter_widget">
							<h4>Newsletter</h4>
							<p>Subscribe to Career Path Pacific newsletter to get the latest jobs posted, candidates ,and
...
<!-- Mirrored from grandetest.com/theme/careerup-html/page-about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2019 19:10:32 GMT -->
