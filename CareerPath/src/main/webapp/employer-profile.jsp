<%-- 
    Document   : employer-profile
    Created on : Sep 23, 2020, 10:15:13 AM
    Author     : HP
--%>
...
<!-- Mirrored from grandetest.com/theme/careerup-html/page-employer-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2019 19:10:18 GMT -->
<head>
<meta charset="utf-8">
						...
						<div class="dropdown">
						    ...
						    <div class="dropdown-menu">
						    	<div class="user_set_header">
							    	<p>Hi, Waruna <br><span class="address">Colombo</span></p>
						    	</div>
					...
					<div class="dropdown">
					    ...
					    <div class="dropdown-menu">
					    	...
					    	<div class="user_setting_content">
								...
								<a class="dropdown-item active" href="page-employer-profile.html"><span class="flaticon-profile"></span> Company Profile</a>
								<a class="dropdown-item" href="page-employer-post-job.html"><span class="flaticon-resume"></span> Post a New Job</a>
								<a class="dropdown-item" href="page-employer-manage-job.html"><span class="flaticon-paper-plane"></span> Manage Jobs</a>
								<a class="dropdown-item" href="page-employer-resume.html"><span class="flaticon-analysis"></span> Shortlisted Resumes</a>
								<a class="dropdown-item" href="page-employer-packages.html"><span class="flaticon-favorites"></span> Packages</a>
						...
						<div class="row">
							...
							<div class="col-md-6 col-lg-6">
								<div class="my_profile_input form-group">
							    	...
							    	<input type="text" class="form-control" id="formGroupExampleInput1" placeholder="Waruna">
								</div>
							</div>
							<div class="col-md-6 col-lg-6">
								<div class="my_profile_input form-group">
							    	<label for="exampleFormControlInput1">Email address</label>
							    	<input type="email" class="form-control" id="exampleFormControlInput1" placeholder="warunahenarangoda@gmail.com">
								</div>
							</div>
							<div class="col-md-6 col-lg-6">
								<div class="my_profile_input form-group">
							    	<label for="exampleInputPhone">Phone</label>
							    	<input type="email" class="form-control" id="exampleInputPhone" aria-describedby="phoneNumber" placeholder="+011 2 750 750">
								</div>
							</div>
							<div class="col-md-6 col-lg-6">
								<div class="my_profile_input form-group">
							    	<label for="exampleFormControlInput2">Website</label>
							    	<input type="email" class="form-control" id="exampleFormControlInput2" placeholder="www.careerpath.com">
								</div>
							</div>
							<div class="col-md-6 col-lg-6">
								<div class="my_profile_input form-group">
							...
							<div class="col-lg-12">
								<div class="my_resume_textarea mt20">
									<div class="form-group">
									    ...
									    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3">Colombo</textarea>
									</div>
								</div>
							</div>
