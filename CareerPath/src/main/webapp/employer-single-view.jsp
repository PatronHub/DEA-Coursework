<%-- 
    Document   : employer-single-view
    Created on : Sep 23, 2020, 10:21:10 AM
    Author     : HP
--%>
...
<!-- Mirrored from grandetest.com/theme/careerup-html/page-employer-single-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2019 19:10:15 GMT -->
<head>
<meta charset="utf-8">
			...
			<div class="row">
				<div class="col-lg-9 col-xl-9">
					<div class="candidate_personal_info style3">
						<div class="thumb">
							<img class="img-fluid" src="images/partners/cl1.jpg" alt="cl1.jpg">
							<div class="cpi_av_rating"><span>4.5</span></div>
						</div>
						<div class="details">
							<h3>Qiwo Smartlink Technology</h3>
							<p class="text-thm2">Arts, Design, Media</p>
							<ul class="address_list">
								<li class="list-inline-item"><a href="#"><span class="flaticon-link text-thm2"></span> www.themeforest.com</a></li>
								<li class="list-inline-item"><a href="#"><span class="flaticon-phone-call text-thm2"></span> +61 3 8376 6284</a></li>
								<li class="list-inline-item"><a href="#"><span class="flaticon-mail text-thm2"></span> <span class="__cf_email__" data-cfemail="8aeeefe7e5cafee2efe7efece5f8eff9fea4e9e5e7">[email&#160;protected]</span></a></li>
							</ul>
			...
			<div class="row">
				...
				<div class="col-xl-4">
					...
					<div class="candidate_working_widget style2 bgc-fa">
						...
						<div class="details">
							<p class="color-black22">Categories</p>
