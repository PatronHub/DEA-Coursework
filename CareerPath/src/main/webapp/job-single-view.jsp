<%-- 
    Document   : job-single-view
    Created on : Sep 23, 2020, 10:23:12 AM
    Author     : HP
--%>
...
<!-- Mirrored from grandetest.com/theme/careerup-html/page-job-single-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2019 19:10:08 GMT -->
<head>
<meta charset="utf-8">
		            ...
		            <li>
		                ...
		                <ul>
		                    <li>
		                        <a href="#">Job List</a>
		                        <ul>
		                            <li><a href="page-job-list-view.html">List Viewed</a></li>
		                    ...
		                    <li>
		                        <a href="#">Job Single</a>
		                        <ul>
		                            <li><a href="page-job-single-view.html">Single Viewed</a></li>
				...
				<div class="col-lg-8 col-xl-9">
					<div class="candidate_personal_info style2">
						<div class="thumb text-center">
							<img class="img-fluid rounded" src="images/partners/cl1.jpg" alt="cl1.jpg"><br><br>
							<a class="mt25" href="#">View all jobs <span class="flaticon-right-arrow pl10"></span></a>
						</div>
						<div class="details">
							<small class="text-thm2">Full Time</small>
							<h3>UX/UI Designer Web & Mobile Platforms</h3>
							<p>Posted 26 September by <a href="#" class="text-thm2">Qiwo Smartlink Technology</a></p>
							<ul class="address_list">
								<li class="list-inline-item"><a href="#"><span class="flaticon-location-pin"></span> Nugegoda</a></li>
								<li class="list-inline-item"><a href="#"><span class="flaticon-price"></span> Rs.15,000 - Rs.20,000 per month</a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="row">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="my_resume_eduarea">
								<h4 class="title">People Also Viewed</h4>
							</div>
						</div>
						<div class="col-lg-12">
				...
				<div class="col-lg-4 col-xl-4">
					...
					<div class="job_info_widget">
						<ul>
							<li><span class="flaticon-24-hours-support text-thm2"></span> <span>35</span> <span>Day</h5></li>
...
<!-- Mirrored from grandetest.com/theme/careerup-html/page-job-single-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2019 19:10:10 GMT -->
</html>