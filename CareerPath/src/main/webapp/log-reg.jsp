				  	...
				  	<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
						<div class="sign_up_form">
							...
							<form action="loginser" method="post" >
								...
								<div class="form-group">
							    	<input type="number" class="form-control" id="exampleInputPhone1" placeholder="PhoneNumber"  name="PhoneNumber">
								</div>
								<div class="form-group">
...
<!--								<form action="#">-->  <form action="loginser" method="post">
									<div class="form-group">
									...
									<div class="form-group">
								    	<input type="number" class="form-control" id="exampleInputPhone1" placeholder="Phone Number" name="PhoneNumber">
									</div>
									<div class="form-group">
										<select id="inputState1" class="form-control">
									        <option selected>Select Sector</option>
									...
									<button type="submit" class="btn btn-log btn-block btn-dark" value="Register" >Register</button>
									<hr>
									<div class="row mt40">
										<div class="col-lg">
											<button type="submit" class="btn btn-block color-white bgc-fb"><i class="fa fa-facebook float-left mt5"></i> Facebook</button>
