<%-- 
    Document   : page-terms-and-policies
    Created on : Sep 23, 2020, 4:17:36 AM
    Author     : HP
--%>
...
<!-- Mirrored from grandetest.com/theme/careerup-html/page-terms-and-policies.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 28 Dec 2019 19:10:42 GMT -->
<head>
<meta charset="utf-8">
...
<div class="wrapper">
	...
	<section class="inner_page_breadcrumb bgc-f0 pt30 pb30" aria-label="breadcrumb">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h4 class="breadcrumb_title float-left">Terms and Policies</h4>
					<ol class="breadcrumb float-right">
					    <li class="breadcrumb-item"><a href="#">Home</a></li>
					    <li class="breadcrumb-item active" aria-current="page">Terms and Policies</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<h4 class="fz20 mt0">Website Terms and Conditions</h4>
                                        <p>Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern CareerPath’s relationship with you in relation to this website. If you disagree with any and conditions of use, which together with our privacy policy govern CareerPath’s relationship with you in relation to this website. If you disagree with any and conditions of use, which together with our privacy policy govern [business name]’s relationship with you in relation to this website. If you disagree with any website.</p><br>
				</div>
				<div class="col-lg-12">
